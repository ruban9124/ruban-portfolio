...
import { Briefcase, Award, Star, Target } from "lucide-react";
  ...
  const experiences = [
    {
      ...
      description:
        "Working as a Frontend Developer on innovative projects, contributing to the development of modern web applications and user interfaces.",
      achievements: [
    ...
    },
    {
      ...
      location: "Coimbatore, India",
      description:
        "Delivered end-to-end solutions including multi-tenant e-commerce platforms, AI-powered chatbots, and cloud-native applications.",
      achievements: [
    ...
    },
    {
      ...
      location: "Coimbatore, India",
      description:
        "Hands-on experience in repairing and maintaining electrical equipment including amplifiers, motors, and home appliances.",
      achievements: [
  ...
  const leadership = [
    {
      ...
      description:
        "Led 5+ client projects independently from planning to deployment with 100% client satisfaction",
    },
    {
      icon: Star,
      title: "Product Development",
      description:
        "Built an multiple Full-Stack projects including Multi Tenant E-commerce, AI Chatbots and AI Agent Flows",
    },
    {
      icon: Award,
      title: "Client Excellence",
      description:
        "Received 5-star reviews for freelance automation projects improving client workflows",
    },
  ];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="grid max-w-5xl mx-auto grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {leadership.map(({ icon: Icon, title, description }, index) => (
              ...
              >
                ...
                <h4 className="font-bold text-gray-900 dark:text-white mb-2 text-xs sm:text-sm md:text-base">
                  {title}
                </h4>
